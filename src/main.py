...
def preprocesing_df(path_wos=None,path_scopus=None):
    ...
    if path_wos:
        ...
        print("5.1. EstandarizaciÃ³n de datos de revistas WoS")
        ...
        try:
            ...
            print("10.1. ConsolidaciÃ³n de autores generada: AuthorPerson/AuthorAlias/AuthorConflicts")
            ...
            print("10.2. AÃ±adido PersonID a Author y ArticleAuthor")
        except Exception as e:
            print(f"[WARN] FallÃ³ la consolidaciÃ³n de autores: {e}")
        ...
        print("15. branches de la network de Scopus aÃ±adidas")
        ...
        print("18. Sacada la informaciÃ³n de la network de WoS de 'Article'")
    ...
    if path_scopus:
        ...
        print("3. ExtracciÃ³n de referencias de Scopus hecha")
        ...
        print("6. Generada columna 'SR_ref' con formato: PRIMERAUTOR, AÃ‘O, SOURCE_TITLE")
        ...
        print("9. Entidad de artÃ­culo obtenida")
        ...
        print("10. EstandarizaciÃ³n de datos de revistas Scopus")
        ...
        scimagodb.to_csv(os.path.join(output_dir,'scimagodb.csv'), index=False)
        print("14. AÃ±adido aÃ±o e informaciÃ³n de Scimago a scimagodb")
        ...
        try:
            ...
            print("17.1. ConsolidaciÃ³n de autores (Scopus) generada y PersonID propagado")
        except Exception as e:
            print(f"[WARN] FallÃ³ la consolidaciÃ³n de autores (Scopus): {e}")
        ...
        affiliation = extract_countries(affiliation_0, country_codes_file)
        affiliation.to_csv(os.path.join(output_dir,'Affiliation.csv'), index=False)
        print("18. Paises de afiliaciÃ³n extraÃ­dos")
