...
from modules.add_year_and_scimago_info import add_year_and_scimago_info # Añade año e información de Scimago a scimagodb
from modules.to_xlsx import combinar_csv_a_excel  # Combina archivos CSV a un archivo
import os
import time
...
def preprocesing_df(path_wos=None,path_scopus=None):
    ...
    if path_scopus:
        # Obtener la carpeta donde está el archivo path_scopus
